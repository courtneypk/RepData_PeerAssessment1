...
g + theme_light() + xlab("Number of Steps Taken per Day") + ylab("Frequency") + 
    ggtitle("Histogram of Total Number of Steps Taken Each Day") + geom_vline(xintercept = mean_steps, color="red") +
...
g2 + geom_line(color="blue") + ylab("Average number of steps in each 5-minute interval") +
    xlab("Time of day") + scale_x_continuous(breaks=c(0,600,1200,1800,2400), labels=c("12:00am","6:00am","12:00pm","6:00pm","12:00am")) + ggtitle("Time-series of the Average Number of Steps\n per 5-minute Interval During the Day")
```
